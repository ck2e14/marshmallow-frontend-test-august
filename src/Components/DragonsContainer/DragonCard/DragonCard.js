            ...
            <div className="info-pane">
               ...
               <div className="about-dragon">
                  ...
                  <div className="about-dragon-contents">
                        {description}<br/> It weighs in at {dry_mass_kg}KG, and is capable of carrying a stunning {outBoundPayloadInKg}KG to the ISS, and {returnPayloadInKg}KG on its return to Earth. <br/>{crew_capacity > 0 ? `${name} can support ${crew_capacity} crew members.` : `${name} does not have human crew capabilities.` }
                  </div>
